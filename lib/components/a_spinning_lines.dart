...
class ASpinningLines extends StatefulWidget {
  final Color color;
  final double size;
  ...
  @override
  State<ASpinningLines> createState() => _ASpinningLinesState();
}

class _ASpinningLinesState extends State<ASpinningLines> with SingleTickerProviderStateMixin {
    ...
    return Center(
      child: AnimatedBuilder(
        builder: (BuildContext context, Widget? child) {
          return CustomPaint(
            painter: _ASpinningLinesPainter(
              _animation.value,
...
class _ASpinningLinesPainter extends CustomPainter {
  _ASpinningLinesPainter(
      this.rotateValue, {
  ...
  /// reference from the https://stackoverflow.com/a/54336099/9689717
  ...
  @override
  bool shouldRepaint(_ASpinningLinesPainter oldDelegate) =>
